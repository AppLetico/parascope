"""
PRD (Product Requirements Document) generator for Prscope.
...
from .config import get_prscope_dir, PrscopeConfig
...
def get_template_env() -> Environment:
    ...
    try:
        return Environment(
            loader=PackageLoader("prscope", "templates"),
            autoescape=False,
            trim_blocks=True,
            lstrip_blocks=True,
        )
